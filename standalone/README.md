...
1. **궤도 배치**에서 궤도 모델과 위성 수를 설정하고 **궤도 배치 적용**을 누릅니다. 지도 위 배치와 선택 관측지의 순간 통신·항법 지표가 갱신됩니다.
2. **상세 분석**에서 국가·관측지, 통신·항법 조건과 분석 기간을 설정합니다. **가시성·통신·항법 분석**으로 선택한 모든 관측지의 기간 결과를 계산합니다.
